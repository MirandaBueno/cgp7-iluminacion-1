...
* 
* Semestre 2023-1:  Crear cilindro, cono y esferas con arreglos dinámicos
*/
#include <stdio.h>
#include <string.h>
#include<cmath>r
...
void CrearCubo()
{
	vector<unsigned int> cubo_indices = {
		// front
		0, 1, 2,
		2, 3, 0,
		// right
	...
	cubo->CreateMesh(cubo_vertices, cubo_indices, cubo_vertices.size(), cubo_indices.size());
...
void CreaPiramide()
{
	...
	obj1->CreateMesh(vertices, indices, vertices.size(), indices.size());
...
void CrearCono(int res,float R) {
	...
	Mesh *cono = new Mesh();
	cono->CreateMesh(vertices, indices, vertices.size(), res + 2);
